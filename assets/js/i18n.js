...
(() => {
  ...
  const T = {
    en: {
      ...
      faq_a_uk: 'Yes — in Ukrainian and many other languages. That\'s what we and our users expect.',
    ...
    uk: {
      ...
      faq_a_uk: 'Так — і українською, і багатьма іншими мовами. Саме цього очікуємо ми й наші користувачі.',
