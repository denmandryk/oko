...
(() => {
  ...
  const T = {
    en: {
      ...
      oko_on: 'Turn on OKO',
      oko_active: 'OKO is narrating the lecture',
      ...
      demo_proto: 'Try the interactive prototype',
      ...
      form_success: 'Thank you! We\'ll reply within 1–2 days.',
      form_error: 'Something went wrong. Try again or email us using the address in the footer.',
    ...
    uk: {
      ...
      demo_proto: 'Спробувати інтерактивний прототип',
      demo_soon: 'незабаром',
      ...
      form_success: 'Дякуємо! Відповімо протягом 1–2 днів.',
      form_error: 'Щось пішло не так. Спробуй ще раз або напиши нам на email із футера.',
